                ...
                <form action="{{ route('taikhoan.update', $taikhoan->id) }} " method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="HoTen" value="{{ $taikhoan->HoTen }}"
                                id="HoTen" placeholder="Họ Tên">
                        </div>
                        <div class="col-lg-6">
                            <label for="exampleInputTopic">Email</label>
                            <input class="form-control" type="text" name="Email" value="{{ $taikhoan->Email }}"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input accept="*.png|*.jpg|*.jpeg" type="file" class="form-control" name="AnhDaiDien"
                                    value="{{ $taikhoan->AnhDaiDien }}" id="AnhDaiDien" placeholder="Chọn ảnh" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="SDT" value="{{ $taikhoan->SDT }}"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="DiaChi" value="{{ $taikhoan->DiaChi }}"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;"
                                class="form-control" name="LoaiTK" value="{{ $taikhoan->LoaiTK }}" id="LoaiTK"
                    ...
                    <div class="row">
                        <div class="col-lg-6" style=" margin-left:-1px">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="TrangThai"
                                class="form-control" id="TrangThai" value="{{ $taikhoan->TrangThai }}"
