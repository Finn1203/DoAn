...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container">
                <!-- form start -->
                <form action=" {{ route('theloaicha.update', $theloaicha->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="TenTheLoaiCha"
                                value="{{ $theloaicha->TenTheLoaiCha }}" id="TenTheLoaiCha" placeholder="Tên danh mục">
                        </div>
