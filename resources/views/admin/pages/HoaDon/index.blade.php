                                        ...
                                        @foreach ($hoadon ?? '' as $hoadons)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($hoadons->PhuongTTT == 1)
                                                        {{ 'Thanh Toán Nhận Hàng' }}
                                                    @elseif ($hoadons->PhuongTTT == 2)
                                                        {{ 'Ví VNP' }}
                                                    @endif
                                                </td>
                                                <td id="trangthai{{ $hoadons->id }}">
                                                    @if ($hoadons->TrangThai == 1)
                                                        {{ 'Đơn Mới' }}
                                                    @elseif ($hoadons->TrangThai == 3)
                                                        {{ 'Đã Duyệt' }}
                                                    @elseif ($hoadons->TrangThai == 4)
                                                        {{ 'Đang Giao Hàng' }}
                                                    @elseif ($hoadons->TrangThai == 0)
                                                        {{ 'Đã Hủy' }}
                                                    @else
                                                ...
                                                <td> <a href="{{ route('print_order', $hoadons->id) }}"
                                                        ...
                                                        style="padding: 0.5rem 1.5rem; border-radius: 10px;"><i
                                                            class='fas fa-edit' style='font-size:15px'></i>In Đơn Hàng</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
