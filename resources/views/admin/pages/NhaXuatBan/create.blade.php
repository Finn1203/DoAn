...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container">
                <!-- form start -->
                <form action=" {{ route('nhaxuatban.store') }} " method="POST" enctype="multipart/form-data"
                    onsubmit="return CheckInput();">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="exampleInputTitle">Tên Nhà Xuất Bản</label>
                            <input class="form-control" type="text" name="tennhaxb" id="tennhaxb"
                    ...
                    <div class="row" style="float:right">
                        ...
                        <a class="btn btn-secondary" href="{{ route('nhaxuatban.index') }}"
