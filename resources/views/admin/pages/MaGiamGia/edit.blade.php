...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container">
                <!-- form start -->
                <form action=" {{ route('magiamgia.update', $magiamgia->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;"
                                class="form-control" value="{{ $magiamgia->TrangThai }}" name="TrangThai" id="TrangThai"
                                placeholder="Status">
