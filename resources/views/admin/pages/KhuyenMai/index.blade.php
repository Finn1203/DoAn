                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0" style="padding-top:50px">
                            <a class="btn btn-primary" href="{{ route('khuyenmai.create') }}"
                                style="padding: 0.5rem 1.5rem; border-radius: 10px; margin-left:40px"><i class='fas fa-plus'
                                        ...
                                        <tbody>
                                            @foreach ($khuyenmai ?? '' as $khuyenmais)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($khuyenmais->TrangThai == 0)
                                                            {{ 'Hết khuyến mãi' }}
                                                        @elseif($khuyenmais->TrangThai == 1)
                                                            {{ 'Còn khuyến mãi' }}
                                                        @elseif($khuyenmais->TrangThai == 2)
                                                            {{ 'Chưa đến thời gian khuyến mãi' }}
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('khuyenmai.edit', [$khuyenmais->id]) }}"
                                                        ...
                                                        <a onclick="return ComfirmDelete();"
                                                            href="{{ route('khuyenmai.delete', [$khuyenmais->id]) }}"
