                ...
                <form action=" {{ route('khuyenmai.update', $khuyenmai->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="TenCTKM" id="TenCTKM"
                                value="{{ $khuyenmai->TenCTKM }}" placeholder="Tên chương trình khuyến mãi">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input type="date" class="form-control" name="ThoiGianBD"
                                    value="{{ $khuyenmai->ThoiGianBD }}" id="ThoiGianBD" placeholder="Thời gian bắt đầu" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input type="date" class="form-control" name="ThoiGianKT"
                                    value="{{ $khuyenmai->ThoiGianKT }}" id="ThoiGianKT" placeholder="Thời gian kết thúc" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="ChietKhau" id="ChietKhau"
                                value="{{ $khuyenmai->ChietKhau }}" placeholder="Nhập số % khuyến mãi">
                        </div>
                    </div>
                    <div class="row" style="float:right">
                        <button type="submit" class="btn btn-success"><i class="fas fa-save"></i></button> &nbsp;
                        <a class="btn btn-secondary" href="{{ route('khuyenmai.index') }}"
