                ...
                <div class="col-md-12" style="margin-left: 80px; padding-right:70px">
                    ...
                    <div class="col-12" style="padding-top:10px;">
                        <ul class="breadcrumb" style="border: none">
                            ...
                            <li>/</li>
                            <li><a href="{{ route('khuyenmai.index') }}">Quản lý khuyến mãi</a></li>
                            <li>/</li>
                ...
                <form action=" {{ route('khuyenmai.store') }} " method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input type="date" class="form-control" name="ThoiGianBD" id="ThoiGianBD"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input type="date" class="form-control" name="ThoiGianKT" id="ThoiGianKT"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="ChietKhau" id="ChietKhau"
                                placeholder="Nhập số % khuyến mãi không được lớn hơn 100%">
                        </div>
                    </div>
