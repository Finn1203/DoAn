                ...
                <form action=" {{ route('nhacungcap.update', $nhacungcap->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="TenNCC" value="{{ $nhacungcap->TenNCC }}"
                                id="TenNCC" placeholder="Tên nhà cung cấp">
                        </div>
                        <div class="col-lg-6">
                            <label for="exampleInputTitle">Địa Chỉ</label>
                            <input class="form-control" type="text" name="DiaChi" value="{{ $nhacungcap->DiaChi }}"
                                id="DiaChi" placeholder="Địa chỉ">
                        </div>
                        <div class="col-lg-6">
                            <label for="exampleInputTitle">Email</label>
                            <input class="form-control" type="text" name="Email" value="{{ $nhacungcap->Email }}"
                                id="Email" placeholder="Email">
                        </div>
                        <div class="col-lg-6">
                            <label for="exampleInputTitle">SDT</label>
                            <input class="form-control" type="text" name="SDT" value="{{ $nhacungcap->SDT }}"
                        ...
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;"
                                value="{{ $nhacungcap->TrangThai }}" name="TrangThai" class="form-control" id="TrangThai"
                                placeholder="Title">
                    ...
                    <div class="row" style="float:right">
                        ...
                        <a class="btn btn-secondary" href="{{ route('nhacungcap.index') }}"
