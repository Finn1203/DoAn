...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container">
                <!-- form start -->
                <form action=" {{ route('tacgia.update', $tacgia->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" type="text" name="tentacgia" value="{{ $tacgia->tentacgia }}"
                                id="tentacgia" placeholder="Tên nhà cung cấp">
                        </div>

                    </div>
                    <div class="row" style="float:right">
                        <button type="submit" class="btn btn-success"><i class="fas fa-save"></i></button> &nbsp;
                        <a class="btn btn-secondary" href="{{ route('tacgia.index') }}"
