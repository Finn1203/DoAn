            ...
            <div class="container">
                ...
                <form action=" {{ route('sach.store') }} " method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="IdNCC"
                                class="form-control" id="IdNCC" placeholder="Title">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="custom-file">
                                <input accept="*.png|*.jpg|*.jpeg" type="file" class="form-control" name="AnhSach"
                                    id="AnhSach" placeholder="Chọn ảnh" name="AnhSach" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="NhaXuatBan"
                                class="form-control" id="NhaXuatBan" placeholder="Title">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="DichGia"
                                class="form-control" id="DichGia" placeholder="Title">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="IdKM"
                                class="form-control" id="IdKM" placeholder="Title">
                                @foreach ($km as $kms)
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="LoaiBia"
                                class="form-control" id="LoaiBia" placeholder="Title">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="KichThuoc"
                                class="form-control" id="KichThuoc" placeholder="Title">
                        ...
                        <div class="col-lg-12">
                            ...
                            <textarea type="text" style="height:100px" class="form-control" name="MoTa" id="MoTa"
                    ...
                    <div class="col-lg-6" style=" margin-left:-12px">
                        ...
                        <select style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" class="form-control"
                            name="TrangThai" id="TrangThai" placeholder="Status">
