                    ...
                    <div class="checkout-left row">
                                            ...
                                            <div class="first-row form-group">
                                                <div class="controls">
                                                    ...
                                                    <input class="billing-address-name form-control"
                                                        value="{{ Auth::user()->HoTen }}" type="text"
                                                        name="name_checkout" placeholder="Họ và tên" readonly />
                                                </div>

                                                <div class="controls">
                                                    <label class="control-label">Số điện thoại:</label>
                                                    <input class="form-control" type="text"
                                                        value="{{ Auth::user()->SDT }}" id ="phone_checkout"
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input class="billing-address-name form-control"
                                                        ...
                                                        name="email-checkout" placeholder="Email" readonly />
                                                </div>
                                                <div class="controls">
                                                    <label class="control-label">Địa chỉ: </label>
                                                    <input class="form-control" type="text" id ="Dia_Chi"
                                                        value="{{ Auth::user()->DiaChi }}" id="Dia_Chi"
                                                        name="address_checkout" placeholder="Địa chỉ" />
                        ...
                        <div class="col-md-7 address_form">
                                    ...
                                    <tbody>
                                        <tr class="rem1">
                                            ...
                                            @foreach ($cart as $book)
                                                ...
                                                <input type="text" hidden value="{{ $book->So_Luong }}"
                                                    name="soluong" />
                            ...
                            <div class="all-total">
                                ...
                                <div class="price-discount" id="div_num_discount" hidden>Khuyến mãi: <p style="color:red"
                                        id="num_discount">15,000 VND</p>
                                </div>
                                ...
                                <div class="discout-payment">
                                    ...
                                    <div class="giamgiatien">
                                        ...
                                        <input type="text" id="coupon" onkeyup="InputCoupon()"
                                            class="form-control coup" name="coupon" placeholder="nhập mã khuyến mãi">
                                        <input hidden id="idDiscount" hidden type="text" name="idDiscount" />
                                        <button type="button" id="btn_check_coupon" onclick="CheckDiscount()"
                                            class="btn btn-success" name="check_coupon">
                                            Tính mã giảm giá</button>
                                        <button type="button" hidden id="btn_remove_coupon"
                                            onclick="EnableCheckCoupon()" class="btn btn-danger" name="remove_coupon">
                                            Hủy</button>
                                    </div>
                                </div>
                            ...
                            <div class="all-total-price">Tổng cộng: <p id="total-money">
                                    {{ number_format($tong_tien + 15000, 0, ',', ',') }} VND</p>
