                                ...
                                <div class="flexslider1">
                                    ...
                                    <ul class="slides">
                                        <li data-thumb="{!! asset('image/' . $books->AnhSach) !!}">
                                            <div class="thumb-image"> <img src="{!! asset('image/' . $books->AnhSach) !!}"
                                ...
                                @foreach ($kho as $khos)
                                    <form action="{{ route('user.thanhtoan') }}" method="POST">
                                        ...
                                        <div class="form-group quantity-box"
                                            style="display: inline-flex;align-items: baseline;justify-content: space-evenly;">
                                            <input class="form-control col-sm-3" id="So_Luong_SP" name="So_Luong"
                                                value="1" min="1" max="{{ $khos->SoLuongTon }}"
                                                type="number" style="width:150px"> (Còn {{ $khos->SoLuongTon }} sản
                                            phẩm)
                                        ...
                                        <div class="occasion-cart" style="display: inline-flex; padding-top:15px">
                                            ...
                                            <div class="googles single-item singlepage" style="margin-left:10px">
                                                <button type="button" onclick="AddCart({{ $books->id }})"
                        ...
                        <div class="bootstrap-tab-text-grids" style="width:1100px">
                                ...
                                @foreach ($binhluan as $preview)
                                    <div class="bootstrap-tab-text-grid">
                                        <div class="bootstrap-tab-text-grid-left">
                                            <br>
                                            <img src="{{ asset('image/' . $preview->TaiKhoan->AnhDaiDien) }}"
                                                alt=" " class="img-fluid"
                            ...
                            <div class="add-review">
                                ...
                                @if (session()->has('infoUser'))
                                    ...
                                    <input class="form-control" type="text" name="HoTen" readonly
                                        placeholder="Bạn hãy nhập tên..." id="inputname"
                                    ...
                                    <input type="text" name="idKH" hidden class="form-control" id="inputid_user"
                                        value="{{ $infoUser['id'] }}">
                                    <input type="text" name="idSach" hidden class="form-control"
                                        id="inputid_sanpham" value="{{ $books->id }}">
                                    <input type="text" name="TrangThai" hidden class="form-control"
                                        id="inputtrangthai" value="1">
