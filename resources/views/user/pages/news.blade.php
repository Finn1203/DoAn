                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/Banner-1000x600px-01.jpg') !!}" class="img-fluid" alt="">
                                    </a>
                                        ...
                                        <div class="grid_meta" style="padding-left:20px; height:100px">
                                            <div class="">
                                                <h6 style="padding-top:20px; color: #959596;">
                                                    <a href="" target="_blank">Khuyến Mãi Hè 2021-Đến Hè Là
                                                        Giảm..!</a>
                                                </h6>
                                            </div>
                                        </div>
                        ...
                        <div class="product-googles-info googles" style="height:400px">
                            <div class="men-pro-item">
                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/banner-tintuc-sukien-he.jpg') !!}" class="img-fluid" alt="">
                                    </a>
                                ...
                                <div class="item-info-product">
                                    <div class="info-product-price">
                                        <div class="grid_meta" style="padding-left:20px; height:100px">
                                            <div class="">
                                                <h6 style="padding-top:20px; color: #959596;">
                                                    <a href="" target="_blank">Chào Tết 2024-Mỗi Gia Đình Là Một Tủ
                                                        Sách Cho Con</a>
                                                </h6>
                                            </div>
                                        </div>
                        ...
                        <div class="product-googles-info googles" style="height:400px">
                            <div class="men-pro-item">
                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/banner-tintuc.jpg') !!}" class="img-fluid" alt="">
                                    </a>
                                ...
                                <div class="item-info-product">
                                    <div class="info-product-price">
                                        <div class="grid_meta" style="padding-left:20px; height:100px">
                                            <div class="">
                                                <h6 style="padding-top:20px; color: #959596;">
                                                    <a href="" target="_blank">[Kho Học Liệu Miễn Phí] Cùng Em Học
                                                        Trực Tuyến - Dành Cho Cấp Mẫu Giáo & Tiểu Học</a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="product-googles-info googles" style="height:400px">
                            <div class="men-pro-item">
                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/banner-tintuc-trungthu.jpg') !!}" class="img-fluid" alt="">
                                    </a>
                                ...
                                <div class="item-info-product">
                                    <div class="info-product-price">
                                        <div class="grid_meta" style="padding-left:20px; height:100px">
                                            <div class="">
                                                <h6 style="padding-top:20px; color: #959596;">
                                                    <a href="" target="_blank">Big Sale: Chào Năm Học Mới-Đón Trung
                                                        Thu Mới</a>
                                                </h6>
                                            </div>
                                        </div>
                        ...
                        <div class="product-googles-info googles" style="height:400px">
                            <div class="men-pro-item">
                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/banner-5k.jpg') !!}" class="img-fluid" alt="">
                                    </a>
                                    <span class="product-new-top" style="background-color: blue;">Sự Kiện</span>
                                </div>
                                <div class="item-info-product">
                        ...
                        <div class="product-googles-info googles" style="height:400px">
                            <div class="men-pro-item">
                                ...
                                <div class="men-thumb-item">
                                    <a href="" target="_blank">
                                        <img style=" width: fit-content;height:200px;object-fit: contain"
                                            src="{!! asset('user/images/banner-tintuc1.jpg') !!}" class="img-fluid" alt="">
                                    </a>
