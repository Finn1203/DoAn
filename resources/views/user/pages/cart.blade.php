            ...
            <div class="inner-sec-shop">
                ...
                <div class="checkout-right">
                        ...
                        <tbody>
                            ...
                            @foreach ($gio_hang as $cart)
                                ...
                                <tr class="rem1">
                                    ...
                                    <td class="invert">
                                        <input type="number" min="1" max="{{ $cart->SLMax }}"
                                            id="So_Luong{{ $cart->id }}"
                                            style="width:50px;border: 1px solid #CDCDCD;color: #868282"
                                            value="{{ $cart->So_Luong }}">
                                    ...
                                    <td class="invert">{{ number_format($cart->Sach->GiaTien * $cart->So_Luong, 0, ',', ',') }}
                                        VND</td>
                                    <td class="invert">
                                        <button class="cart-hover" type="submit"
                                            onclick="UpdateCart({{ $cart->id }}, {{ $cart->SLMax }})"
                                            style="background:white; border:none; cursor:pointer"><i class="fas fa-sync-alt"
                    ...
                    <div class="col-md-4 checkout-right-basket">
                        <ul>
                            <li style="font-size:120%; font-weight:600">Thành Tiền: &nbsp;
                                {{ number_format($tongall, 0, ',', ',') }} VND
