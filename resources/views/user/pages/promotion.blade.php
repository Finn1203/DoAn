                                ...
                                <ul class="dropdown-menu6">
                                    <li>
                                        ...
                                        <input type="text" id="start_price" name="start_price"
                                            value = "{{ $min_price }}" hidden />
                                        <input type="text" id="end_price" name="end_price" value = "{{ $max_price }}"
                                            hidden />
                                        <input type="text" id="start_price_range" value = "{{ $min_price_range }}"
                                            hidden />
                                        <input type="text" id="end_price_range" value = "{{ $max_price_range }}"
                                            hidden />
                                        ...
                                        <div class="product-googles-info googles">
                                            <div class="men-pro-item">
                                                <div class="men-thumb-item">
                                                    ...
                                                    @if ($books->GiaKM != 0)
                                                        <span
                                                            class="product-new-top">-{{ $books->KhuyenMai->ChietKhau }}%</span>
                                                    @else
                                                                ...
                                                                <div class="grid-price mt-2">
                                                                    @if ($books->GiaKM != 0)
                                                                        <div class="price"><span
                                                                                class="money ">{{ number_format($books->GiaKM, 0, ',', ',') }}
                                                                                VND</span></div>

                                                                        <div class="rootprice"> <del> <span
