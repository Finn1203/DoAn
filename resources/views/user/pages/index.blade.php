                ...
                @foreach ($slideshow as $slideshows)
                    <div class="carousel-item active"><img src="{!! asset('image/' . $slideshows->HinhAnh) !!}" class="img-fluid" alt="">
                        <div class="carousel-caption text-center">
                            ...
                            <a href="{{ route('user.shop') }}" class="btn btn-sm animated-button gibson-three mt-4">Đến Cửa
                                Hàng</a>
                        </div>
                    </div>
                @endforeach
                                        ...
                                        <div class="men-thumb-item">
                                            ...
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{ route('user.single', $bestSellers1->id) }}"
                                            ...
                                            <div class="info-product-price">
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <h4 style="padding-top:20px">
                                                            <a
                                                                href="{{ route('user.single', $bestSellers1->id) }}">{{ $bestSellers1->TenSach }}</a>
                                                        </h4>
                                                        <div class="grid-price mt-2">
                                                            <span
                                                                class="money ">{{ number_format($bestSellers1->GiaTien, 0, ',', ',') }}
                                                                VND</span>
                                                        </div>
                                                    </div>
                                                </div>
