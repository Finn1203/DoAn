    ...
    <section class="banner-bottom-wthreelayouts py-lg-5 py-3">
        <div class="container" style="border: solid 1px">
            <div class="inner-sec-shop px-lg-4 px-3">
                ...
                <div class="row" style="padding-top:20px">
                    <div class="col-lg-12" style="display: inline-flex;">
                        ...
                        <div class="col-lg-6">
                            ...
                            @if ($hoadon['PhuongTTT'] == 1)
                                <b style="color:red">Thanh toán khi nhận hàng(COD)</b>
                            @elseif ($hoadon['PhuongTTT'] == 2)
                                <b style="color:red">Thanh toán qua VNPay</b>
                            @endif
                ...
                <div class="row" style="float: right; padding-top: 15px; margin-bottom:50px; font-size: 130%">Tổng tiền:
                    &nbsp; <b style="color:red">{{ number_format($hoadon->TongTien, 0, ',', ',') }} VND</b></div>
            </div>
        </div>
    </section>
    <!--//checkout-->
