...
@section('content')
            ...
            @if (session()->has('infoUser') != null)
                ...
                <div class="responsive_tabs">
                    ...
                    <div style="padding-bottom:10px; text-align:center">
                        <img src="{{ asset('image/' . $user['AnhDaiDien']) }}" alt=""
                    ...
                    <table class="thong-tin" style="border-style:double">
                        <tbody>
                            ...
                            <tr>
                                <td><button class="btn btn-success" style="font-size:90%" data-toggle="modal"
                                        data-target="#exampleEditModalCenter">CẬP NHẬT</button>
                                <td>
                            </tr>
                        </tbody>
                    </table>
                                        ...
                                        <tbdody>
                                            @foreach ($don_hang as $order)
                                                <tr>
                                                    ...
                                                    @if ($order->TrangThai == 1)
                                                        <td><a href="{{ route('account.cancelorder', $order->id) }}"
    ...
    <div class="modal fade" id="exampleEditModalCenter" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#ffa500a8;">
                    <h5 class="modal-title" id="exampleModalLongTitle"
                        style="color:white; font-size:120%; padding-left:130px">THÔNG TIN CÁ NHÂN</h5>
                ...
                @if (session()->has('infoUser') != null)
                    ...
                    ?>
                    <form action="{{ route('user.updateinfomation', $myaccount) }}" method="POST"
                        enctype="multipart/form-data" id="save1">
                        @csrf
                        <div class="modal-body" style="margin-top:10px; padding-left:10px; padding-right:10px">
                            <div class="row">
                                ...
                                <div class="col-lg-12" style="margin-top:20px">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user['HoTen'] }}" name="HoTen"
                                        placeholder="Họ tên">
                                </div>
                                <div class="col-lg-12" style="margin-top:20px">
                                    <label for="exampleInputTopic">Số điện thoại</label>
                                    <input type="text" class="form-control" value="{{ $user['SDT'] }}" name="SDT"
                                        placeholder="Số điện thoại" id ="phone_checkout">
                                </div>
                                <div class="col-lg-12" style="margin-top:20px; margin-bottom:10px">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user['DiaChi'] }}" name="DiaChi"
                                        placeholder="Địa chỉ" id ="Dia_Chi">
                                </div>
                            </div>
                        </div>
