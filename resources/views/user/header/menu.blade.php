    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-bottom: -10px">
        <ul class="navbar-nav nav-mega mx-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="{{ route('user.shop') }}" id="navbarDropdown" role="button"
                ...
                <ul class="dropdown-menu mega-menu">
                    <li>
                        ...
                        <hr>
                        <a href="{{ route('user.shop') }}" style="text-align:center;color:black">
            ...
            <li style="padding: 5px 0 0 15px;">
                <form id="form-search" action="{{ route('Search') }}">
                    ...
                    <button
                        style="border-radius: 0.25rem; padding: 0.25rem 0.5rem; background-color: rgb(104, 101, 92); color: cornsilk;"
                        type="button" onclick="saveSearch()">
