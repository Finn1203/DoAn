    ...
    <header>
        <div class="row">
            ...
            <div class="col-md-3 top-info text-left mt-lg-4">
                <img width="70%" height="70%" src="{!! asset('user\images\logo-2.png') !!}" class="img-fluid" style="margin-top: -45px;"
                    alt="">
            </div>
            ...
            <div class="col-md-3 text-right mt-lg-4">
                <ul class="cart-inner-info">
                    ...
                    @if (session()->has('infoUser') != null)
                        <li>
                            <span class="wishlist"> <a href="{{ route('user.wishlist') }}" class="hover-nut"> <i
                                        class="fas fa-heart" aria-hidden="true"></i> </a> </span>
                    ...
                    <li class="dropdown">
                        @if (session()->has('infoUser') == null)
                            <span class="fa fa-user" aria-hidden="true" style="color: rgb(35, 175, 156);"></span><a
                                href="{{ route('getLogin') }}" class="hover-nut"> Đăng Nhập </a>
                        @else
                            <span class="fa fa-user" aria-hidden="true" style="color: rgb(35, 175, 156);"><a
                                    id="a" class="hover-nut dropdown-toggle" href="#"
                                    data-toggle="dropdown" style="margin-left: 5px;"
                                    id="profileDropdown"><?php $infoUser = session()->get('infoUser'); ?>Hi!&nbsp{{ $infoUser['HoTen'] }} </a>
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                    ...
                                    <a class="dropdown-item hover-nut" href="{{ route('getLogout') }}"
                                        style="text-transform: none;font-size: 1rem;letter-spacing: 3px;color: #9c9b9b;cursor: pointer">
                    ...
                    <!-- Giỏ hàng -->
                    <li>
                        <div><span class="fas fa-cart-plus" aria-hidden="true"
                                style="color: rgb(35, 175, 156)"></span><a href="{{ route('user.cart') }}"
                                class="hover-nut">Giỏ hàng </a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('updateAccount', $myaccount['id']) }}" method="POST"
                            enctype="multipart/form-data" onsubmit="return CheckPass();">
                            {{ csrf_field() }}
                            <div class="modal-body" style="margin-top:10px; padding-left:10px; padding-right:10px">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="password" class="form-control" name="passwordcu"
                                            id="passwordcu">
                                    </div>
