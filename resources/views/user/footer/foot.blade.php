  ...
  (function(d, s, id) {
    ...
    <script>
        ...
        function validateAddress(address) {
            ...
            if (((!address.val().includes('xã') && !address.val().includes('Xã')) && (!address.val().includes('phường') && !
            ...
            if (((!address.val().includes('huyện') && !address.val().includes('Huyện')) && (!address.val().includes(
            ...
            if (((!address.val().includes('tỉnh') && !address.val().includes('Tỉnh')) && (!address.val().includes('tp') && !
